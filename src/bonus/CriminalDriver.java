...
public class CriminalDriver extends Driver {
    ...
    /**
     * for criminal driver the method treats both junctions and roads and replaces
     * the checkAvailability method also.
     * 
     * @param vehicle
     */
    @Override
    ...
    public void stayOnCurrentPart(Vehicle vehicle) {
        if (vehicle.getCurrentRoutePart() instanceof Road) {
            ...
            System.out.println("- " + vehicle.getStatus() + road + ", time to arrive: "
                    + (road.calcLength() / vehicle.getVehicleType().getAverageSpeed()
