...
public class LightedJunction extends Junction {
    ...
    /**
     * Random Constructor creates random traffic lights for the junction.
     */
    ...
    public double calcEstimatedTime(Object obj) {
        if (!lights.getTrafficLightsOn())
            ...
            return (getEnteringRoads().size() - 1) * lights.getDelay() + 1;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!super.equals(other))
            return false;
        if (!lights.equals(((LightedJunction) other).getLights()))
            return false;
        return true;
    }
